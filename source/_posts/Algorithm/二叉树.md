...
例如，假如我们有 5 个加权的节点
![Huffman Nodes](https://img.blog.csdn.net/20140213234608531)

根据上面的步骤，我们可以得到如下的树：

![Huffman Tree](https://img.blog.csdn.net/20140213234743687)

或者如下的树：

![Huffman Tree](https://img.blog.csdn.net/20140213234754390)
